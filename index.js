( function recetaDeAlfajores() {
    var imgNum1= document.getElementsByClassName(imagines[0])
    var imgNum2= document.getElementsByClassName(imagines[1])
    var imgNum3= document.getElementsByClassName(imagines[2])
    var imgNum4= document.getElementsByClassName(imagines[3])
    var imgNum5= document.getElementsByClassName(imagines[4])
    var linkfinalDelArchivo="pagina wed donde sace la receta";
    var href="https://www.recetasgratis.net/receta-de-alfajores-de-maicena-45370.html"
    var linkFinal= linkfinalDelArchivo.link(href);
    var cuerpo={
        "titulo":"receta de alfajor de maicena",
        "imagen despues del titulo": imgNum1,
        "subtitulo":"hecho por la maestra de dulces katuchini XD",
        "informacion":"Los alfajores son un dulce típico de varios países de América Latina y se caracterizan por obtener una forma redondeada y estar rellenos de crema dulce. Los más famosos son los argentinos y los peruanos pero en la actualidad se preparan alfajores caseros en muchos otros países.",
        "ingredientes":[
        ...
        "Preparacion":{
            ...
            "imagen vatiendo huevos": imgNum2,
            "tercer paso":[
                "3.",
            ...
            "imagen masa cortada en circulos": imgNum3,
            "sectimo paso":[
                "7.",
            ...
            "imagen hechando dulce de leche en la galleta": imgNum4,
            "decimo paso":[
                "10.",
